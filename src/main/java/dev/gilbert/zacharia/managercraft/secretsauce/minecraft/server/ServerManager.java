...
public class ServerManager {
    ...
    @Autowired
    public ServerManager(RconHandler rconHandler,
    ...
    public GenericResponseMessage startServer(MinecraftStartServerRequest request) {
        ...
        String launchJarName = getLaunchJarName(request);
        ...
        List<String> serverArgs = getLaunchServerArgs(request, launchJarName);
    ...
    private List<String> getLaunchServerArgs(MinecraftStartServerRequest request, String launchJarName) {
        ...
        customArgs.add("-XX:+UnlockExperimentalVMOptions");
    ...
    private List<String> getAllJarsInDirectory(String rootServersDir, String server) {
    ...
    private String getServerLaunchJarName(String rootServersDir, String server) {
        List<String> jarsInDirectory = getAllJarsInDirectory(rootServersDir, server);
    ...
    private String getLaunchJarName(MinecraftStartServerRequest request) {
        ...
        if (request.getLaunchJarName() == null || request.getLaunchJarName().isEmpty()) {
            launchJarName = getServerLaunchJarName(rootServersDir, request.getServer());
        }
